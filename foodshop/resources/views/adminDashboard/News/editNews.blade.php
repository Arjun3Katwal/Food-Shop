        ...
        <div class="pl-lg-4">
          ...
          <div class="col-lg-9">
            <div class="form-group">
              ...
              <input type="text" name="name" class="form-control" value="{{$new->name}}" placeholder=" Pname">
            </div>
          </div>
            ...
            <div class="col-lg-9">
              <div class="form-group">
                ...
                <textarea name="description" rows="5" cols="40" class="form-control tinymce-editor">{{$new->description}}</textarea>
              </div>
            </div>
            <div class="col-lg-9">
              <div class="form-group">
